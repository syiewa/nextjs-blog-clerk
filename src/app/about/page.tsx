      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Syiewa&apos;s Blog! Created by Syiewa Ghavidel, this
              blog serves as a personal platform to share his insights and ideas
              with the world. Syiewa is an enthusiastic developer who enjoys
            ...
            <p>
              ...
              engineering, and programming languages. Syiewa is continually
